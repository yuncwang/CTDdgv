                                ...
                                <div class="col-md-12">
                                    <div class="thumbnail" style="height: 100%;">
                                        ...
                                        <div class="caption">
                                            ...
                                            <p>
                                                A tool that utilizes mutation profiles and patient survival information to predict tumor driver genes and tumor driver variants, A tool that utilizes mutation profiles and patient survival information to predict tumor driver genes and variants, as well as to perform survival analysis.
                                            <p>
                                            <div style="position: absolute;bottom: 20px;left: 50%;transform: translateX(-50%)">
                                ...
                                <div class="col-md-12">
                                    <div class="thumbnail" style="height: 100%;">
                                        ...
                                        <div class="caption">
                                            ...
                                            <p>
                                                Providing bulk downloads of clinically relevant variants, genes, as well as predictive tumor driver genes and variants.
                                            </p>
                                            <div style="position: absolute;bottom: 20px;left: 50%;transform: translateX(-50%)">
        ...
        <div class="col-md-12 col-sm-12 column" id="index_foot_top" >
            ...
            <div class="col-md-5 col-sm-5 column">
                <div class="foot_message" data-aos="fade-up" data-aos-duration="1000"  data-aos-delay="1000">
                    <h4>Please cite:</h4>
                    <p>CTDdgv: a web server for the identification and clinical interpretation of ctDNA variants in cancer</p>
