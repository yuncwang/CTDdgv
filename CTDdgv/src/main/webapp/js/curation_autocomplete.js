...
$(function () {
    ...
    var diseaseArray = $.map(pre_disease, function (value, key) { return { value: value, data: key }; });
    var geneArray = $.map(pred_gene, function (value, key) { return { value: value, data: key }; });
    $('#pre_gene_quick').autocomplete({
    ...
    $('#pre_disease_quick').autocomplete({
        // serviceUrl: '/autosuggest/service/url',
        lookup: diseaseArray,
        lookupFilter: function(suggestion, originalQuery, queryLowerCase) {
            var re = new RegExp('\\b' + $.Autocomplete.utils.escapeRegExChars(queryLowerCase), 'gi');
